...
import School.View.Data;
import School.View.User;
import School.Database.database;
import School.View.Course;
...
//    DATABASE TOOL
    ...
    public void navButton(){
        ...
        home.setOnMouseClicked((MouseEvent event) ->{
            ...
            btnCourse.setStyle("-fx-background-color:linear-gradient(to bottom right,"
                    + " rgba(121, 172, 255, 0.2), rgba(255, 106, 239, 0.2))");
        });
        ...
        btnCourse.setOnMouseClicked((MouseEvent event) ->{
    ...
    @FXML
    private AnchorPane course_page;
...
//        I FORGOT THAT WE NEED TO CREATE A REPORT DOCUMENT FIRST!
        try{
            ...
            JasperDesign jDesign = JRXmlLoader.load("D:\\Semester 3\\PBO\\PROJECT\\School-Management-System-project\\School Management System\\src\\School\\Asset\\report1.jrxml");
...
//        ASC MEANING, ASCENDING ORDER
    ...
    public void logoutAccount(){
        ...
        try{
    //                NAME OF LOGIN FORM
            Parent root = FXMLLoader.load(getClass().getResource("/School/Model/FXMLDocument.fxml"));
...
//        SHOW STUDENT RECORD TO TABLE VIEW
    ...
    @FXML
    private TableView<Course> tCourse;
    ...
    public ObservableList<Course> CourseList(){
        ...
        try{
            ...
            while(result.next()){
                ...
                containData = new Course(result.getInt("id")
    ...
    @FXML
    private TableColumn col_c_id;
    
    @FXML
    private TableColumn col_c_name;
    
    @FXML
    private TableColumn col_c_semester;
    
    @FXML
    private TableColumn col_c_desc;
    
        public void showCourse(){
        
        ObservableList<Course> courseRecord = CourseList();
        
//        TO SHOW THE DATA TO TABLE VIEW
        col_c_id.setCellValueFactory(new PropertyValueFactory<>("id"));
        col_c_name.setCellValueFactory(new PropertyValueFactory<>("course_name"));
        col_c_semester.setCellValueFactory(new PropertyValueFactory<>("semester"));
        col_c_desc.setCellValueFactory(new PropertyValueFactory<>("description"));

        
        tCourse.setItems(courseRecord);
    ...
    public void insertCourse()throws SQLException{
        ...
        connect = database.connectDb();
//        I HAVE 7 COLUMN!
        String sql = "INSERT INTO course(course_name, semester, description) VALUES(?,?,?)";
        
        try{
            
            if(nameC.getText().isEmpty()
                    | semesterC.getText().isEmpty() 
                    | descriptionC.getText().isEmpty() ){
                ...
                prepare = connect.prepareStatement(sql);
//                prepare.setString(1, id.getInte());
                prepare.setString(1, nameC.getText());
                prepare.setString(2, semesterC.getText());
                prepare.setString(3, descriptionC.getText());
    ...
    public void selectCourse(){
        ...
        int num = tCourse.getSelectionModel().getSelectedIndex();
        
        Course course1 = tCourse.getSelectionModel().getSelectedItem();
        
        if(num-1 < -1)
            return;
        
        idC.setText(String.valueOf(course1.getId()));
        nameC.setText(course1.getCourse_name());
        semesterC.setText(course1.getSemester());
        descriptionC.setText(course1.getDescription());
    ...
    public void updateCourse(){
        ...
        String sql = "UPDATE course SET `course_name` = '" + nameC.getText()
                + "', `semester` = '" + semesterC.getText() 
                + "', `description` = '" + descriptionC.getText()
                + "' WHERE `id` =" + idC.getText() + "";
    ...
    public void deleteCourse(){
        ...
        String sql = "DELETE FROM course WHERE `id` ='" + idC.getText() + "'";
