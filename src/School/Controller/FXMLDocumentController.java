    ...
    public void login(){
        ...
        try{
            ...
            if(result.next()){
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/School/Model/Dashboard.fxml"));
...
//        String sql = "SELECT count(username) FROM account";
        ...
        try{
            ...
            if(result.next()){
                ...
                String count = result.getString("count(email)");
    ...
    public void signup(){
        ...
        try{
            ...
            }else if(su_password.getText().length() < 1){
...
//                    String uri = "D:\\Semester 3\\PBO\\PROJECT\\School-Management-System-project2\\Del Management System\\src\\School\\logo.jpg";
//                    
//                    User.path = uri;
...
//                    prepare.setString(4, User.path);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        countRow();
        create_acc.setOnAction(event ->{
            changeForm(event);
        });
        
        login_acc.setOnAction(event -> {
            changeForm(event);
        });
